...
// Loaded body — same layout as the student detail screen:
// top bar (back + share/wishlist) → video → hero → about → certificates
// → reviews, with a fixed booking button pinned to the bottom.
...
// Booking button pinned to the bottom — opens the parent booking flow.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GestureDetector(
        onTap: () => showParentBookingSheet(context, profile, tutorId),
        child: Container(
