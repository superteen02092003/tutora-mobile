...
import '../../features/tutor/presentation/pages/tutor_profile_page.dart';
import '../../features/tutor/presentation/pages/tutor_schedule_page.dart';
import '../../features/tutor/presentation/shell/tutor_shell.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.tutorHome, builder: (context, _) => const TutorHomePage()),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.tutorSchedule, builder: (context, _) => const TutorSchedulePage()),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.tutorContribute, builder: (context, _) => const TutorContributePage()),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.tutorProfile, builder: (context, _) => const TutorProfilePage()),
          ]),
        ],
      ),
    ],
