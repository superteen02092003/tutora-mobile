...
abstract final class AppTextStyles {
  ...
  // Heading levels
  static TextStyle h1({Color color = AppColors.ink}) => display(color: color).copyWith(fontSize: 32);
  static TextStyle h2({Color color = AppColors.ink}) => display(color: color).copyWith(fontSize: 24);
  static TextStyle h3({Color color = AppColors.ink}) => display(color: color).copyWith(fontSize: 20);
  ...
  static TextStyle label({Color color = AppColors.ink}) =>
      GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w600, color: color, letterSpacing: 0.01);
  ...
  static TextStyle serifItalic({Color color = AppColors.ink2, double fontSize = 16}) =>
